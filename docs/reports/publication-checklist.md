...
- [x] Public repository destination: `https://github.com/yangzhiloh/Tiktoky`
...
- [x] Stable release destination:
      `https://github.com/yangzhiloh/Tiktoky/releases/tag/prooflens-e2-rc1`
...
- [ ] Record the 2-to-4-minute demonstration using `docs/video-script.md`
- [ ] Upload the video to an approved public destination
